      ...
      >
        <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item" v-if="user && admin">
            <router-link to="/ResidentManagement" class="nav-link"
              >Manage</router-link
            >
          </li>
          <li class="nav-item" v-if="user && !admin">
            <router-link to="/HealthSummary" class="nav-link"
          ...
          <li class="nav-item dropdown" v-if="user">
            ...
            >
              <li v-if="!admin">
                <router-link class="dropdown-item" to="/HistoricalData"
                  >Historical Data</router-link
                >
              </li>
              <li>
                <router-link to="/ContactUs" class="dropdown-item"
                  >Contact</router-link
                >
              </li>
              <li>
                <router-link to="/ProfilePage" class="dropdown-item"
